...
model = addReactionsHH(model,{'Liver_r08623'},{'Methylation of 8-methoxykynurenate (Liver)'}, {'Liver_C02470[c] + Liver_amet[c] <=> Liver_C05830[c] + Liver_ahcys[c]'},{''},{'Reaction, cytosol'},couplingFactor);
...
model = addReactionsHH(model,{'Ovary_r03955'},{'Methylation of 8-methoxykynurenate (Ovary)'}, {'Ovary_C02470[c] + Ovary_amet[c] <=> Ovary_C05830[c] + Ovary_ahcys[c]'},{''},{'Reaction, cytosol'},couplingFactor);
model = addReactionsHH(model,{'Breast_r03955'},{'Methylation of 8-methoxykynurenate (Breast)'}, {'Breast_C02470[c] + Breast_amet[c] <=> Breast_C05830[c] + Breast_ahcys[c]'},{''},{'Reaction, cytosol'},couplingFactor);
...
model = addReactionsHH(model,{'Uterus_r03955'},{'Methylation of 8-methoxykynurenate (Uterus)'}, {'Uterus_C02470[c] + Uterus_amet[c] <=> Uterus_C05830[c] + Uterus_ahcys[c]'},{''},{'Reaction, cytosol'},couplingFactor);

param.SIabsorp = 'n'; % only colon
param.LIabsorp = 'y';% only colon
param.BileDuct = 'n';% only colon
param.Diet = 'n';% only colon
param.PeripheralOrgan = {'Liver', 'Spleen', 'Adipocytes', 'Retina', 'Heart', 'Ovary', 'Breast', 'Bcells', 'Brain', 'Muscle', 'Agland', 'Uterus'};
Metabolite = 'C05830';
...
save('Harvetta_104c_8methoxykynurenate_PhysC', 'model')