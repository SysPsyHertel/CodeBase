%% Add 8-Methoxykynurenate to Harvetta_1_04b
...
modelN = addMetabolite(modelN, 'Testis_C05830[c]', '8-Methoxykynurenate');
...
modelN = addReaction(modelN,'Testis_r03955','reactionFormula','Testis_C02470[c] + Testis_amet[c]  -> Testis_C05830[c] + Testis_ahcys[c]');
...
modelN.lb(n-10:n) = -1000000;
modelN.ub(n-10:n) = 1000000;

for i = 1:10
modelN.grRules{n-10+i,1} = '8623.1';
end
model = modelN;
...
model = addMetabolite(model, 'Testis_C05830[e]', '8-Methoxykynurenate');
...
model = addReaction(model,'Testis_tr8mthx','reactionFormula','Testis_C05830[c]  -> Testis_C05830[e]');
...
model.lb(n-10:n) = -1000000;
model.ub(n-10:n) = 1000000;
...
% Testis
idx = find(string(model.rxns) == 'Testis_EX_C02470(e)_[bc]')
model.lb(idx)
model.ub(idx)
model = addReaction(model,'Testis_EX_C05830(e)_[bc]','reactionFormula','Testis_C05830[e]  -> C05830[bc]', lowerBound=model.lb(idx), upperBound=model.ub(idx));
...
save('Harvey_104b_8methoxykynurenate', 'model') 