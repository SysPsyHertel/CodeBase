...
% path to and name of the file with abundance information
 ...
 %% Read in raw abundances and normalize them
abunFilePath_nn = 'C:\Users\faesslerd\Documents\Projects\raw_abundances.csv'
[normalizedCoverage,normalizedCoveragePath] = normalizeCoverage(abunFilePath_nn)

abunFilePath = [pwd filesep 'normCoverage_CRC.csv'];

% download AGORA and specify its path
agoraPath = 'C:\AGORA_1_03_mat';
...
% define path to models with diet constraints, generated by mgPipe
